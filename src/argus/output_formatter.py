...
from argus.models import (
    AnalysisScopeFinalScopeLabels,
    AnalysisScopeScenariosItem,
    CompositeInterpType,
    CompositeTableHeadersType,
    ConfigurationDataQuality,
    ...
    TemporalAnalysisFraudTimelineEntityDetails,
...
class ForensicReportWriter:
    ...
    def __init__(
        ...
        analysis_period: str,
        output_template: TemplateLoader | None = None,
